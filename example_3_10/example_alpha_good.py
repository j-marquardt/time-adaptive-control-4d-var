...
from helper import *
from settings_alpha_good import *
...
for alpha in alphas:
    ...
    if alpha in plot_p_for:
        ...
        if save_figures:
            plt.savefig('compare-alpha-good-p.eps', bbox_inches='tight', pad_inches=0)
    ...
    if alpha in plot_p_for:
        ...
        if save_figures:
            plt.savefig('compare-alpha-good-y.eps', bbox_inches='tight', pad_inches=0)
...
helper.compare_controls(
    ...
    xvals=[0.25, 0.25] + len(alphas) * [0.75])

if save_figures:
    plt.savefig('compare-alpha-good-controls.eps', bbox_inches='tight', pad_inches=0)
